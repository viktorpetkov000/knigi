  ...
  <body>
    ...
    <div class="main-container">
      ...
      Tempus morbi vitae facilisis morbi volutpat mauris sit.
				...
				<img class="about-info-picture" src="assets/books5.png">
				</div>

			<div class="about-counters-container">
				<div class="about-counter user-counter">
					<img src="./assets/users.png" class="about-counter-image"/>
				...
				<div class="about-counter item-counter">
					<img src="./assets/cat-1.png" class="about-counter-image"/>
				...
				<div class="about-counter deal-counter">
					<img src="./assets/deals.png" class="about-counter-image"/>
